...
{
    public partial class Frm_ModificacionFormaPago : Form
    {
        ...
        // CONSTRUCTOR
        public Frm_ModificacionFormaPago()
        {
            InitializeComponent();
        }
        ...
        private void Frm_ModificacionFormaPago_Load(object sender, EventArgs e)
        {
        ...
        private void btn_aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (tratamiento.Validar(this.Controls) == Tratamientos_Especiales.Resultado.correcto)
            {
                ...
                formaP.Modificar(Pp_id_forma_pago, this.Controls);
                if (MessageBox.Show("La forma de pago se modificó con éxito", "Aviso", MessageBoxButtons.OK) == DialogResult.OK)
                {
                    this.Close();
                }
            }
