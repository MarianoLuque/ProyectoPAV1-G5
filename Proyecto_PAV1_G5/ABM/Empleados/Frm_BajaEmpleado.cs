    ...
    public partial class Frm_BajaEmpleado : Form
    {
        ...
        private void btn_aceptar_Click_1(object sender, EventArgs e)
        {
            ...
            if (tratamiento.Validar(this.Controls) == Tratamientos_Especiales.Resultado.correcto)
            {
                ...
                {
                    empleado.Eliminar(Pp_legajo, this.Controls);
                }
                if (MessageBox.Show("El empleado se eliminó con éxito", "Aviso", MessageBoxButtons.OK) == DialogResult.OK)
                {
                    this.Close();
                }
            }
        ...
        private void Frm_BajaEmpleado_Load_1(object sender, EventArgs e)
        {
