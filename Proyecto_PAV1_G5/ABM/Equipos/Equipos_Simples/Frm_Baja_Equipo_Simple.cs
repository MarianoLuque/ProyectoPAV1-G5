    ...
    public partial class Frm_Baja_Equipo_Simple : Form
    {
        ...
        private void btn_Aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (tratamiento.Validar(this.Controls) == Tratamientos_Especiales.Resultado.correcto)
            {
                ...
                equipo.Eliminar(Pp_codigo_equipo, this.Controls);
                if (MessageBox.Show("El equipo se eliminó con éxito", "Aviso", MessageBoxButtons.OK) == DialogResult.OK)
                {
                    this.Close();
                }
            }
        ...
        private void Frm_Baja_Equipo_Simple_Load(object sender, EventArgs e)
        {
