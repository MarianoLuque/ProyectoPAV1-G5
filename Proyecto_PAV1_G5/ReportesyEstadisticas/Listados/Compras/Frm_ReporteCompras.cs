...
namespace Proyecto_PAV1_G5.Reportes_y_Estadísticas.Listados
{
    public partial class Frm_ReporteCompras : Form
    {
        ...
        private void ArmarReporteRemito1(DataTable tabla)
        {
            ...
            if (Rb01.Checked == true)
                reporte_ventas.LocalReport.ReportEmbeddedResource = "Proyecto_PAV1_G5.ReportesyEstadisticas.Listados.Compras.ReporteCompras.rdlc";
            else
                reporte_ventas.LocalReport.ReportEmbeddedResource = "Proyecto_PAV1_G5.ReportesyEstadisticas.Listados.Compras.ReporteCompras2.rdlc";
