...
{
    public partial class Frm_Estadistica_Rubros : Form
    {
        NE_Ventas venta = new NE_Ventas();
        DataTable Tabla = new DataTable();
        public Frm_Estadistica_Rubros()
        {
            InitializeComponent();
        }

        private void Frm_Estadistica_Rubros_Load(object sender, EventArgs e)
        {
            cmb_tipo_factura.CargarCombo(venta.DatosComboTipoFactura());
            cmb_tipo_factura.Enabled = false;
            txt_fecha.ReadOnly = true;
            this.reporte_rubros.RefreshReport();
        }
        ...
        private void CargarReporte()
        {
            ...
            ReportDataSource datos = new ReportDataSource("DataSetRubros", Tabla);

            reporte_rubros.LocalReport.ReportEmbeddedResource = "Proyecto_PAV1_G5.ReportesyEstadisticas.Estadisticas.EstadisticasVale.Estadistica_Rubros.rdlc";
